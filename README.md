...
1. What is the current state of tech where english to sql query generators are ? (Literature)
    ...
    **Code**: [https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main)  (Very Important by Alibaba Research, and many papers are related to this)
    ...
    [https://huggingface.co/datasets/sede](https://huggingface.co/datasets/sede) Paper: [https://aclanthology.org/2021.nlp4prog-1.9.pdf](https://aclanthology.org/2021.nlp4prog-1.9.pdf) , Model T5 Paper:  [https://arxiv.org/pdf/1910.10683.pdf](https://arxiv.org/pdf/1910.10683.pdf) 
    ...
    **Available online tools, licenses and pricing:** 
    ...
    [https://www.producthunt.com/products/text2sql-ai/alternatives](https://www.producthunt.com/products/text2sql-ai/alternatives) 
    
    [https://www.ai2sql.io/](https://www.ai2sql.io/)
    [https://www.text2sql.ai](https://www.text2sql.ai/)
    
    Nichness Tools ****SQL - Sentence to SQL Query (Beta) Generator**** [https://nichesss.com/tools/sql-sentence-to-sql-query-beta-generator-k8mrJOQVG](https://nichesss.com/tools/sql-sentence-to-sql-query-beta-generator-k8mrJOQVG) 
    
    [https://www.logicloop.com/ai-sql-query-generator](https://www.logicloop.com/ai-sql-query-generator) 
    
    [https://gpt3demo.com/apps/simple-english-to-sql](https://gpt3demo.com/apps/simple-english-to-sql) 
...
2. How do we imagine this entire system would look like, in terms of architecture and components used?
    ...
    - [ ]  Overall Tech pipeline using visuals
    - [ ]  Reproduce:
